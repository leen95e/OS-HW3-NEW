...
typedef struct Threads_stats {
    ...
    pthread_mutex_t lock; // Guards the counters above (read by master on UDP pings)
} * threads_stats;

// Formats <t_stats>'s counters (Stat-Thread-*) into buf, used to answer UDP
// statistics pings. Returns the number of bytes written.
